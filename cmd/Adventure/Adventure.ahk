...
0 := 0
global command_pid := A_Args[2]
global db_file_path := A_Args[3]
...
write2db(data, id)
{
    ...
    sql := "UPDATE node SET txt = '" data "' WHERE node_id = " id ";"
    ...
    if(A_IsCompiled)
    {
        run, %A_ScriptDir%/../../cherry-snippet.exe
    }
    else
    {
        run,% A_ScriptDir "\..\..\v1\AutoHotkey.exe " A_ScriptDir "\..\..\cherry-snippet.ahk"
    }
    */
    return
}
